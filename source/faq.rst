...
``(section_id, offset)``
   ...
   .. _morph-tool: https://github.com/openbraininstitute/morph-tool
...
SNAP handles it like this, as described `here <https://github.com/openbraininstitute/snap/commit/c211d79ccc01bf2b0dcc621d12a5bba054a03ff7>`_.
